...
namespace TelerikMovies.Tests.TelerikMoviesServices.MoviesServiceTests
{
    ...
    public class GetRandomMovies
    {
        ...
        [TestMethod]
        public void ReturnsAllNotDeleteIfCountOfAllLessOrEqualsAllInDataBaseNotDeletedCount()
        {
            //Arrange
            ...
            //Act
            var result = sut.GetRandomMovies(4);
            ...
            Assert.IsTrue(result.Select(x => x.Id).Contains(testMovie4.Id));
            Assert.IsTrue(result.ToList().Count == 3);
        }
        [TestMethod]
        public void ReturnsExactCountEvenIfInDBAreMoreNotDeleted()
        {
            //Arrange
            var likes = new List<Likes>();
            likes.Add(new Likes());
            ...
            //Act
            var result = sut.GetRandomMovies(2);
